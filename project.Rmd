...
ggplot(data_clean_2014, aes(x = date, y = n_killed, group=month)) + geom_histogram(stat="identity", binwidth=  100) +labs(x= "Dates", y="Number killed", title= "Distribution of people killed by Gun Violence in 2014")
