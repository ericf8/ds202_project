...
In this histogram, we can see a distribution of incidences across all the years (2013 - 2018). The years that we have comprehensive data for, 2014 - 2017, shows us that the number of gun violence incidences is increasing and that 2018 is on track to do the same. 
